...
While this is a neat theoretical idea, there are also many practical problems as we mentioned before. The major point is that how accurate should the map be in order to have an acceptable estimation? And is it even feasible to do so if the surface of building are changed very often?
