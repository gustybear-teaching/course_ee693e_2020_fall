...
***
## Paper Summary
  With the increased usage of Internet of Things (IoT) Devices, securtiy concerns start to rise. One such example that this paper brings up is with WiFi, BLE, and Zigbee devices that are connected together and used in a home or office setting. 
